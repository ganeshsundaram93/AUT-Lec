%% Example_4_ARE.m
%
% Investigation of Stability and Performance for the Solution of the ARE as Terminal Weighting Matrix 
%
% Related Slides:         4-35
% Related Simulink Model: none
%
% Experiments:            Investigate the prediction accuracy
%
% Remarks:                none
%
...
P = dare(A,B,Q,R);          % terminal weighting matrix (solution of the ARE)
