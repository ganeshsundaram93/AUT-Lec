...
magspecdata= np.load("glass_spec.npy")
...
for i in range (0, 5):
    if i==0: 
        Spec_Class2 = magspecdata[:,0]
        Spec_Class1 = magspecdata[:,5]
    else:
        Spec_Class2 = Spec_Class1 + magspecdata[:,i]
        Spec_Class1 = Spec_Class1 + magspecdata[:,i+5]

Spec_Diff = abs(Spec_Class1-Spec_Class2)/5
...
plotall(magspecdata,y)
np.save('glass_spec_sel.npy',magspecdata)
